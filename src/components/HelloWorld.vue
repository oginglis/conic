...
export default {
  ...
  mounted() {
    const sketch = (p5) => {
        ...
        update () {
          ...
          if (this.pulled) {
            if (p5.dist(p5.mouseX, p5.mouseY, this.x, this.y) < 2 * this.size ) {
              this.x = p5.constrain(p5.mouseX, p5.windowWidth / 3.5, p5.windowWidth / 1.4);
              this.y = p5.constrain(p5.mouseY, 300, 399);
            }
          }

          if (this.fired && this.y !== (p5.windowHeight)){
      ...
      //        Velocity X Axis
            if (this.vx === 0) {
              this.vx = p5.windowWidth / 2 - this.x;
              console.log(this.vx);
            }
      ...
      class Rope {
        constructor(b){
          this.ballx = b.x;
          this.bally = b.y;
          this.post1 = p5.windowWidth / 3.5;
          this.post2 = 300;
          this.post3 = p5.windowWidth / 1.4;
          this.post4 = 300;
        }
